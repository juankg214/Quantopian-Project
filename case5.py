...
def make_pipeline():
    ...
    growth_score = growth_score.winsorize(min_percentile=0.05, max_percentile=0.95)
    retained_earnings = retained_earnings.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
          20*growth_score.zscore()
        +15*free_cash_flow.zscore()
        +15*dps_growth.zscore()
        +operating_cash_flow.zscore()
        +cash_flow_from_continuing_operating_activities.zscore()
        +retained_earnings.zscore()
